...
default.mark(function e(r) {
    ...
    default.wrap(function(e) {
            ...
            case 4:
                ...
                return a = e.t1.value,
                n = t[a],
                app.logger.info("loading model", n),
                o = path.basename(n, ".js"),
                s = changeCase.pascalCase(o),
                i = path.join(r, n),
                p = require(i),
                app.model[s] = app.db.define(changeCase.snakeCase(o), p, {
                    timestamps: !1
                }),
                e.next = 15,
                app.model[s].sync();
...
default.mark(function e(r) {
    ...
    default.wrap(function(e) {
            ...
            case 0:
                ...
                helpers.PIFY(fs.readdir)(r);
            case 2:
                for (a in t = e.sent) n = t[a],
                app.logger.info("loading contract", n),
                o = path.basename(n, ".js"),
                s = changeCase.snakeCase(o),
                i = path.join(r, n),
                p = require(i),
                "index.js" !== n && (app.contract[s] = p);
            case 4:
            case "end":
                return e.stop()
            }
...
default.mark(function e(r) {
    ...
    default.wrap(function(e) {
            ...
            case 0:
                ...
                helpers.PIFY(fs.readdir)(r);
            case 2:
                for (t = e.sent, a = !0, n = !1, o = void 0, e.prev = 6, s = (0, _getIterator3.
            default)(t); ! (a = (i = s.next()).done); a = !0) p = i.value,
                app.logger.info("loading interface", p),
                require(path.join(r, p));
                e.next = 14;
                break;
            case 10:
                e.prev = 10,
            ...
            case 0:
                ...
                app.validators = {
                    ...
                    array: function(e, r) {
                        if (r.length) {
                            if (! (0, _stringify2.
                        default)(validate.isArray(e))) return "Is not an array";
                            if ((0, _stringify2.
                        default)(validate({
                                data:
                                e
                            ...
                            }))) return "Arrary lentgh is incorrect,correct length is " + (0, _stringify2.
                        default)(r.length)
                        }
                    }
                },
                ...
                app.setDefaultFee = function(e, r) {
                    app.defaultFee.currency = r,
                    app.defaultFee.min = e
                },
                ...
                e.next = 20,
                loadModels(path.join(rootDir, "model"));
            case 20:
                return e.next = 22,
                loadModels(path.join(dappRootDir, "model"));
            case 22:
                return e.next = 24,
                loadContracts(path.join(rootDir, "contract"));
            case 24:
                return e.next = 26,
                loadContracts(path.join(dappRootDir, "contract"));
            case 26:
                return e.next = 28,
                loadInterfaces(path.join(rootDir, "interface"));
            case 28:
                return e.next = 30,
                loadInterfaces(path.join(dappRootDir, "interface"));
            case 30:
                return e.next = 32,
                app.sdb.load("Balance", app.model.Balance.fields(), [["address", "currency"]]);
            case 32:
                return e.next = 34,
                app.sdb.load("Variable", ["key", "value"], ["key"]);
            case 34:
                return e.next = 36,
                app.sdb.load("RoundFee", app.model.RoundFee.fields(), [["round", "currency"]]);
            case 36:
...
function runDapp(e) {
    ...
    r.on("exit",
    function(r) {
        var t = this; (0, _asyncToGenerator3.
    default)(_regenerator2.
    default.mark(function r() {
        ...
        default.wrap(function(r) {
                ...
                case 5:
                    ...
                    e.logger.error("Failed to close db:", r.t0);
                case 8:
                case "end":
                    return r.stop()
                }
...
"/" !== dappRootDir[0] && (dappRootDir = path.join(process.cwd(), dappRootDir)),
    ...
    default.wrap(function(e) {
            ...
            case 0:
                try {
                    ...
                    app.logger.error("Failed to initialize app sandbox"),
                    process.exit(1)
                }
            case 1:
            case "end":
