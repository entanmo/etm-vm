...
Transaction.prototype.create = function(e, r, t) {
    ...
    return n.signature = modules.api.crypto.sign(r, this.getBytes(n)),
    n.id = this.getId(n),
    n
},
...
Transaction.prototype.getBytes = function(e, r) {
    try {
        ...
        throw app.logger.debug("Failed to get transaction bytes", r, e),
        Error(r.toString())
    }
    return t.toBuffer()
},
...
default.mark(function e(r, t) {
    ...
    default.wrap(function(e) {
            ...
            case 11:
                if (i = a.split("."), o = (0, _slicedToArray3.
            default)(i, 2), s = o[0], u = o[1], s && u) {
                    e.next = 14;
                    break
                }
