...
default.mark(function o() {
    ...
    default.wrap(function(r) {
            ...
            case 0:
                return r.prev = 0,
                r.next = 3,
                modules.blockchain.blocks.getCommonBlock(e.height, t);
            case 3:
                if (a = r.sent, app.logger.info("Get common block", a.height, a.id), a.height === e.height) {
                    r.next = 8;
                    break
                }
                return app.logger.debug("---commonBlock", a, "---lastBlock", e),
                r.abrupt("return", n("Reject fork chain"));
            case 8:
                return r.next = 11,
                PIFY(modules.blockchain.blocks.loadBlocksPeer)(e.height, t);
            case 11:
                return i = r.sent,
                app.logger.info("Loading " + i.length + " blocks"),
                r.next = 15,
                app.db.transaction();
            case 15:
                c = r.sent,
            ...
            case 18:
                ...
                if (s = r.t1.value, !((u = i[s]).height > e.height)) {
                    r.next = 24;
                    break
                }
                return r.next = 24,
                modules.blockchain.blocks.processBlock(u, {
                    noTransaction: !0
                });
            case 24:
                r.next = 18;
            ...
            case 37:
                e = modules.blockchain.blocks.getLastBlock(),
                r.next = 8;
                break;
            case 40:
                return app.logger.info("Sync blocks completed"),
                r.abrupt("return", n());
            case 44:
                return r.prev = 44,
                r.t3 = r.
                catch(0),
                r.abrupt("return", n("Failed to sync blocks: " + r.t3));
            case 47:
            case "end":
                return r.stop()
            }
...
private_.blockSync = function(e) {
    modules.api.blocks.getHeight(function(t, n) {
        ...
        modules.api.transport.getRandomPeer("get", "/blocks/height", null,
        function(t, n) {
            return t ? e("Failed to get blocks height: " + t) : (app.logger.info("blockSync get block height", n), n.body && n.body.success ? bignum(r.height).gte(n.body.height) ? e() : void private_.findUpdate(r, n.peer, e) : e("Failed to get blocks height: " + n.body))
        })
    })
},
private_.loadMultisignatures = function(e) {
    modules.blockchain.accounts.getExecutor(function(t, n) {
        if (t) return e(t);
        modules.api.multisignatures.pending(n.keypair.publicKey.toString("hex"), !0,
        function(t, r) {
            ...
            async.eachSeries(a,
            function(e, t) {
                modules.api.multisignatures.sign(n.secret, null, e.transaction.id,
                function(e) {
                    e && o.push(e),
                    (0, _setImmediate3.
                default)(t)
...
Sync.prototype.onBlockchainLoaded = function() { (0, _setImmediate3.
default)(function e() {
        library.sequence.add(private_.blockSync,
        function(t) {
            t && app.logger.error("Sync#blockSync timer", t),
            setTimeout(e, 1e4)
        })
    }),
    (0, _setImmediate3.
default)(function e() {
        library.sequence.add(private_.transactionsSync,
        function(t) {
            t && app.logger.error("Sync#transactionsSync timer", t),
            setTimeout(e, 1e4)
        })
    })
},
