...
private_.apies = {},
private_.appApiHandlers = {},
private_.loaded = !1,
private_.ns = function(e, r) {
    var t, a;
    t = e[(a = r.split("."))[0]];
...
Api.prototype.onBlockchainLoaded = function() {
    ...
    try {
        ...
        app.logger.error("Failed to load routes.json"),
        process.exit(4)
    }
    ...
    n = void 0;
    try {
        for (var o, i = (0, _getIterator3.
    default)(r); ! (t = (o = i.next()).done); t = !0) {
            var p = o.value;
...
default.mark(function e() {
    ...
    default.wrap(function(e) {
            ...
            case 6:
                ...
                return p = i.value,
                app.logger.info("register app interface", p.method, p.path),
                e.next = 11,
                PIFY(modules.api.dapps.registerInterface)(p);
            case 11:
                t = !0,
                e.next = 6;
                break;
            ...
            case 30:
                ...
                app.logger.error("Failed to register dapp interface", e.t1),
                process.exit(5),
                e.abrupt("return");
            case 35:
            case "end":
        ...
        e, this, [[0, 30], [4, 16, 20, 28], [21, , 23, 27]])
    }))(),
...
Api.prototype.message = function(e, r) {
    library.bus.message("message", e.query),
    r(null, {})
},
module.exports = Api;