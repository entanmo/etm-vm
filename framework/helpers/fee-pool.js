...
default)(e, [{
    ...
    },
    {
        ...
        value: function(e, r) {
            ...
            a = this.sdb.get(MODEL_NAME, t);
            if (a) {
                var u = bignum(a.amount).plus(r).toString();
                this.sdb.update(MODEL_NAME, {
                    amount: u
                },
                t)
            } else t.amount = r,
            this.sdb.create(MODEL_NAME, t)
        }
    },
    {
        key: "getFees",
        value: function() {
            var e = this.sdb.entries(MODEL_NAME);
            app.logger.debug("fee pool get fees", e, this.round);
            var r = new _map2.
        default,
            t = !0,
            a = !1,
            u = void 0;
            try {
                for (var l, i = (0, _getIterator3.
            default)(e); ! (t = (l = i.next()).done); t = !0) {
                    var s = (0, _slicedToArray3.
                default)(l.value, 2),
                    o = s[0],
                    n = s[1],
                    c = o.split(","),
