...
private_.row2parsed = function(e) {
    ...
    l = void 0;
    try {
        for (var n, o = (0, _getIterator3.
    default)((0, _keys2.
    default)(e)); ! (t = (n = o.next()).done); t = !0) {
            var s = n.value;
            r.push(e[s])
        }
    } catch(e) {
    ...
    c = p.length,
    d = 0; d < c; d++) u = r[d],
    f[d] === Buffer ? i[p[d]] = f[d](u, "hex") : f[d] === Array ? i[p[d]] = r ? u.split(",") : [] : u && (i[p[d]] = f[d](u));
    return i
},
private_.parseFields = function(e) {
    for (var r, t = (0, _keys2.
default)(e), a = [], l = t.length, n = 0; n < l; n++) r = e[t[n]],
    a[n] = r === Boolean ? Boolean: r === Date ? Date: r || String;
    return {
        f: t,
        p: a
    }
...
Sql.prototype.select = function(e, r, t) {
    ...
    library.sandbox.sendMessage(a,
    function(e, a) {
        r && !e && (a = util.isArray(r) ? a.map(private_.row2object, r) : a.map(private_.row2parsed, private_.parseFields(r))),
        t(e, a)
    })
},
